...
namespace Todo.Domain.Tests.QueryTests
{
    ...
    public class TodoQueryTests
    {
        ...
        public TodoQueryTests()
        {
            ...
            _items.Add(new TodoItem("Tarefa 3", DateTime.Now, "brunogomes"));
            _items.Add(new TodoItem("Tarefa 4", DateTime.Now, "usuarioA"));
            _items.Add(new TodoItem("Tarefa 5", DateTime.Now, "brunogomes"));
        }

        [TestMethod]
        public void Dada_a_consulta_deve_retornar_tarefas_apenas_do_usuario_andrebaltieri()
        {
            var result = _items.AsQueryable().Where(TodoQueries.GetAll("brunogomes"));
